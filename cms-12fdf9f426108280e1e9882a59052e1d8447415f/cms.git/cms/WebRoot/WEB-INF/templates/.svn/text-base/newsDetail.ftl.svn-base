   ...
   <div class="center">
     ...
     <div id="middle_left">
       ...
       <div id="crub">
            ...
            <a href="html/subItems/subItem${news.subItem.subItemID}-1.html">${news.subItem.subItemName}/ </a> 
       </div>
        <div id="arc_til">
               	<h1>${news.title}</h1>
                <p id="r_let">${news.createtime?string('yyyy-MM-dd HH:mm:ss')}&nbsp;&nbsp;
               <#if news.source!="">
					来源：${news.source}&nbsp;&nbsp;
				</#if>
                作者：${news.author}&nbsp;&nbsp;
       ...
       <div id="arc_cont">
       			<#if recruitSchoolName!="取消"><!--这是数据库中默认的在不选择招聘 时存放一个空字符串-->
                	<div class="cont_time_position">地点：${news.recruitSchoolName}&nbsp;&nbsp;${news.recruitRoomName}&nbsp;&nbsp;&nbsp;
                	</div><br/>
