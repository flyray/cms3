       ...
       <span id="recruit_title">新闻标题</span><span id="recruit_adress">招聘地点</span><span id="recruit_time">招聘时间</span><hr />
        ...
        <ul>
			<#list newsList as news>
				<li><a href="html/news/${news.createtime?string('yyyy')}/${news.createtime?string('MM')}/${news.createtime?string('dd')}/news-${news.newsID?c}.html" title="${news.title}"><#if news.settop==1>【置顶】<#if news.bold==1><strong></#if>${news.getTitle(28)}<#if news.bold==1></strong></#if><#else><#if news.bold==1><strong></#if>&nbsp${news.getTitle(30)}<#if news.bold==1></strong></#if></#if></a><span class="recruit_adress">${news.getRecruitSchoolName()}-${news.getRecruitRoomName()}</span><span class="xiaozhao_list_time">${news.recrutTime?string('yyyy')}-${news.recrutTime?string('MM')}-${news.recrutTime?string('dd')}&nbsp;${news.recrutTime?string('HH:mm')}</span></li>
        ...
        <div id="xiaozhao_right_bottom">
                     ...
                     <#if currentPage gt 1>
                     	<a href="html/recruit/recruit-1.html">首页&nbsp;&nbsp;</a>
                     	<a href="html/recruit/recruit-${currentPage-1}.html">&nbsp;上一页&nbsp;</a>
                     <#else>
                     	首页&nbsp;&nbsp;
                     	&nbsp;上一页&nbsp;
                     </#if>
                     <#if currentPage lt pageNum>
                     	<a href="html/recruit/recruit-${currentPage+1}.html">&nbsp;下一页&nbsp;</a>
                     	<a href="html/recruit/recruit-${pageNum}.html">&nbsp;尾页&nbsp;</a>
                     <#else>
                     	&nbsp;下一页&nbsp;
                     	&nbsp;尾页&nbsp;
                     </#if>
                     &nbsp;页次${currentPage}/${pageNum}&nbsp;|跳转到：
             <input type="text" value="" name="rb_search" id="xiaozhao_rb_search"/>
