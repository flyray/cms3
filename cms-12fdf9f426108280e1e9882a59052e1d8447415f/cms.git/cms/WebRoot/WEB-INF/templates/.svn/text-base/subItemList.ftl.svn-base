...
<div id="middle_content">
   <div class="center">
     ...
     <div id="middle_right">
          <div id="crub">
            <a href="">首页&nbsp;/</a>
            <a href="html/items/item${item.itemID?c}-1.html">${item.itemName}&nbsp;/</a>
            <a href="html/subItems/subItem${subItem.subItemID?c}-1.html">${subItem.subItemName}&nbsp;/</a>
          </div>
          <h1>${subItem.subItemName}</h1>
		...
		<div id="right_list">
           <ul>		
            ...
            <div id="right_bottom">
                     ...
                     <#if currentPage gt 1>
                     	<a href="html/subItems/subItem${subItem.subItemID?c}-1.html">首页&nbsp;&nbsp;</a>
                     	<a href="html/subItems/subItem${subItem.subItemID?c}-${currentPage-1}.html">&nbsp;上一页&nbsp;</a>
                     <#else>
                     	首页&nbsp;&nbsp;
                     	&nbsp;上一页&nbsp;
                     </#if>
                     <#if currentPage lt pageNum>
                     	<a href="html/subItems/subItem${subItem.subItemID?c}-${currentPage+1}.html">&nbsp;下一页&nbsp;</a>
                     	<a href="html/subItems/subItem${subItem.subItemID?c}-${pageNum}.html">&nbsp;尾页&nbsp;</a>
                     <#else>
                     	&nbsp;下一页&nbsp;
                     	&nbsp;尾页&nbsp;
                     </#if>
