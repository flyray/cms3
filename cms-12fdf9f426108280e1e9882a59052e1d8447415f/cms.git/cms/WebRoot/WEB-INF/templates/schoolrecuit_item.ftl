    ...
    <div id="xiaozhao_content">
       ...
       <span id="recruit_title">新闻标题</span><span id="recruit_adress">招聘地点</span><span id="recruit_time">招聘时间</span><hr />
        ...
        <div id="xiaozhao_right_bottom">
                     ...
                     <#if currentPage gt 1>
                     	<a href="html/items/item7-1.html">首页&nbsp;&nbsp;</a>
                     	<a href="html/items/item7-${currentPage-1}.html">&nbsp;上一页&nbsp;</a>
                     <#else>
                     	首页&nbsp;&nbsp;
                     	&nbsp;上一页&nbsp;
                     </#if>
                     <#if currentPage lt pageNum>
                     	<a href="html/items/item7-${currentPage+1}.html">&nbsp;下一页&nbsp;</a>
                     	<a href="html/items/item7-${pageNum}.html">&nbsp;尾页&nbsp;</a>
                     <#else>
                     	&nbsp;下一页&nbsp;
                     	&nbsp;尾页&nbsp;
                     </#if>
