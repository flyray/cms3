		...
		<div class="fenye">
			&nbsp;共<s:property value="page.totalPage"/>页  第${currentPage}页
				<s:if test="page.hasPrePage">
					<a href="log_news_findAll?currentPage=1&newsTitle=${log.newsTitle}" class="font_b">首页</a>
					<a href="log_news_findAll?currentPage=${currentPage - 1}&newsTitle=${log.newsTitle}" class="font_b">上一页</a>
				</s:if>
				<s:else>
					首页
					上一页
				...
				<s:if test="page.hasNextPage">
					<a href="log_news_findAll?currentPage=${currentPage + 1}&newsTitle=${log.newsTitle}" class="font_b">下一页</a>
					<a href="log_news_findAll?currentPage=${page.totalPage}&newsTitle=${log.newsTitle}" class="font_b">尾页</a>
				</s:if>
				<s:else>
					下一页
					尾页
